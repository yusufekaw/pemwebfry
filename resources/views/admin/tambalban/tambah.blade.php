    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <!-- form start -->
          <form method="post" action="{{ url('admin/tambalban/simpan') }}" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              <div class="form-group col-sm-12">
                <label for="nama">Latitude</label>
               	<input type="text" step="any" name="latitude" id="latitude" class="form-control" value="{{ old('latitude') }}" readonly="readonly" required>
               	@error('latitude')
               	<span class="help-block">{{ $message }}</span>
               	@enderror
              </div>
              ...
              <div class="form-group col-sm-12">
               ...
               <input type="text" class="form-control col-sm-6" name="longitude" id="longitude" class="form-control" value="{{ old('longitude') }}" readonly="readonly" required>
                @error('longitude')
                <span class="help-block">{{ $message }}</span>
                @enderror
              </div>
